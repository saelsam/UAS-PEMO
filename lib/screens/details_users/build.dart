...
import 'package:kebab_ned/screens/details_users/beli.dart';

import 'package:kebab_ned/screens/details_users/descriptions.dart';
import 'package:kebab_ned/screens/details_users/image_product.dart';
                ...
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      description_users(product: product),
                      const SizedBox(height: kDefaultPaddin / 2),
                      beli_users(product: product),
                      const SizedBox(height: kDefaultPaddin / 2),
